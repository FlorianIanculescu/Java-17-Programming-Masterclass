...
//                updateRecord(statement, tableName, columnName, columnValue, columnName, columnValue.toUpperCase());
    ...
    private static void insertArtistAlbum(Statement statement, String artistName, String albumName)
        ...
        String albumInsert = "INSERT INTO music.albums (album_name, artist_id) VALUES (%s, %d)"
                .formatted(statement.enquoteLiteral(artistName), artistId);
...
//            int deleteArtists = statement.executeUpdate(deleteArtist);
//            System.out.printf("Deleted %d rows from music.albums%n", deleteArtists);
